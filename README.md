...
We opt for a 15-degree rotation to simulate a badly positioned chest X-ray.
...
At this point of the project does not make much sense present results in terms of, for instance, accuracy since we trained the model with a small number of images.
